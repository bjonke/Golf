...
public:
	...
	GolfBall() : currentHeight(0.0f) , x(0.0f) , y(0.0f) , distance(0.0f), height(0.0f), InHole = (false) {};
	...
	bool setInHole( bool YesNo ) { InHole = YesNo; };
	bool setLanded( bool YesNo ) { Landed = YesNo; };
